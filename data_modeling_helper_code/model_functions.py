...
def accuracy(model_outputs, ground_truth_labels):
    """
    Returns accuracy score

    Arguments:
    model_outputs -- outputs generated by GRU network
    ...
    return torch.tensor(torch.sum(predictions == ground_truth_labels).item() / len(predictions))
